...
public class FileSelectionActivity extends Activity {
    ...
    private static final String MY_PREFS_NAME ="MyFileLocation" ;
  ...
  //  public SharedPreferences sp;
    ...
    public void ok(){
        ...
        final AppDetails globalObject = (AppDetails) getApplicationContext();
        globalObject.setFilesLocations(resultFileList);

        String finalpath = resultFileList.toString().replace("[", "");
        finalpath=finalpath.replace("]","");
        filePaths=finalpath.split(",");
       // Toast.makeText(this, ""+filePaths[0], Toast.LENGTH_SHORT).show();
        //Toast.makeText(this, ""+filePaths.length, Toast.LENGTH_SHORT).show();
        Intent result = this.getIntent();
        result.putExtra(FILES_TO_UPLOAD, resultFileList);
        setResult(Activity.RESULT_OK, result);

       // SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(FileSelectionActivity.this);
        //SharedPreferences.Editor editor = prefs.edit();
        //editor.putString("Location", ""+filePaths[0]);
        //editor.commit();
       // Intent i = new Intent(FileSelectionActivity.this,ShowActivity.class);
       // i.putExtra("FileList",filePaths);
       // fds.setFilePaths(filePaths);
      //  startActivity(i);
        finish();
    }
